// Copy of some data structure used in GRUB multiboot.
...
struct multiboot_t {
     ...
     */
    // In short, this points to an array whose elements represents the info of
    // available physical memory blocks.
